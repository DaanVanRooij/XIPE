...
st.write(":lightgreen-background[Green cells] are a decrease in emissions, :salmon-background[red cells] are an increase in emissions and :lightyellow-background[yellow cells] have no changes.")
