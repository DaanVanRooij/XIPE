...
st.write(":green-background[Green cells] are a decrease in emissions, :red-background[red cells] are an increase in emissions and :yellow-background[yellow cells] have no changes.")
